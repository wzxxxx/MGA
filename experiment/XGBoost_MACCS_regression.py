...
for xgb_graph_feats_task in task_list:
    ...
    print('***************************************************************************************************')
    args = {}
    training_set = pd.read_csv(xgb_graph_feats_task+'_MACCS_training.csv', index_col=None)
    valid_set = pd.read_csv(xgb_graph_feats_task+'_MACCS_valid.csv', index_col=None)
    test_set = pd.read_csv(xgb_graph_feats_task+'_MACCS_test.csv', index_col=None)
    ...
    result_pd.to_csv(xgb_graph_feats_task+'_MACCS_result.csv', index=False)
    parameters[str(xgb_graph_feats_task)]=args
result_xgb.to_csv('XGB_MACCS_result_regression.csv', index=False)
filename = open('xgb_MACCS_parameters_regression.txt', 'w')
